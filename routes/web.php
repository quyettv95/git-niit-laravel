...
Route::post('anh-gai-xinh', function() {
    $images = [
        'https://image.freepik.com/free-photo/portrait-cute-girl-with-long-hair_1153-5227.jpg',
        'https://i.pinimg.com/736x/25/3a/80/253a806bac2290aad35d0bebbc93459e.jpg',
        'https://i.pinimg.com/564x/29/c5/20/29c520a65cc2c23d253d3e8a1ce27970.jpg',
        'https://pbs.twimg.com/media/EMx6nlKU0AA5473.jpg',
        'https://3.bp.blogspot.com/-D9O9iQaW1kI/Xf9heQYVyiI/AAAAAAAAK64/o-OTGA95Up8tPbaK_r89MKcxWI8YtunqQCNcBGAsYHQ/s1600/youshinebling_71298385_166315041274879_3868666664713943647_n.jpg',
        'https://i.pinimg.com/originals/7d/0c/84/7d0c845f5176d2a50bcae132a026d08e.jpg'
    ];

    $imagesCollection = collect($images);

    echo "<img src='{$imagesCollection->random()}'>";
    //git
})->name('anh-gai-xinh');
...
Route::post('add-fav-post', function () {
    $postId = request()->input('id');
    \Auth::user()->posts()->attach($postId);
    echo "Add success";
})->name('add-fav-post');
