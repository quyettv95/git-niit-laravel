            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                @foreach($posts as $post)
	                <div class="row pb-4">
	                    <div class="col-md-5">
	                        <div class="fh5co_hover_news_img">
	                            <div class="fh5co_news_img"><img src="{{ $post->getThumnail() }}" alt=""/></div>
	                            <div></div>
	                        </div>
	                    </div>
	                    <div class="col-md-7 animate-box" style="position: relative;">
	                        <br>
                            @if (Auth::check())

                                @if (Auth::user()->isFav($post))
                                    <div class="btn-fav" data-id="{{ $post->id }}" style="position: absolute; top: 0; right: 20px">
                                ...
                                @endif
                            @endif
	                        <a href="{{ route('post.show', $post->slug) }}" class="fh5co_magna py-2"> {{ $post->title }} </a>
            ...
            $('.btn-fav').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        console.log(result)
                        toastr.success('Bạn đã lưu tin thành công')
